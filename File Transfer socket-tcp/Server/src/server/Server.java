            ...
            public void run() {
                try {
                    ...
                    while (true) {
                        ...
                        RandomAccessFile file = new RandomAccessFile("G:\\server.txt", "r");
                        String str;
                        Integer mx = -987654321, mn=987654321, avg=0;
                       ...
                       Writer writer = null;
                        try {
                            ...
                            new FileOutputStream("G:\\output.txt"), "utf-8"));
                            writer.write("Minimun = "+mn+"\nMaximum = "+mx+"\nAverage = "+avg);
